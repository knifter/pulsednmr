...
set_property PACKAGE_PIN M14 [get_ports {sync}]
set_property IOSTANDARD LVCMOS33 [get_ports {sync}]
set_property SLEW FAST [get_ports {sync}]
set_property DRIVE 8 [get_ports {sync}]

set_property PULLUP true [get_ports {pulse_on}]
set_property PACKAGE_PIN M15 [get_ports {pulse_on}]
set_property IOSTANDARD LVCMOS33 [get_ports {pulse_on}]
set_property SLEW FAST [get_ports {pulse_on}]
set_property DRIVE 8 [get_ports {pulse_on}]
