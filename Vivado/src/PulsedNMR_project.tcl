...
#
# Generated by Vivado on Mon May 06 17:54:38 +0200 2019
...
#
#    "D:/NMR.git/Vivado/PulsedNMR/PulsedNMR.srcs/sources_1/imports/src/PulsedNMR_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "D:/NMR.git/Vivado/src/nmrpulsesequencer.v"
#    "D:/NMR.git/Vivado/src/PulsedNMR.xdc"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../localcores"]" $obj
...
# Hierarchical cell: StatusReg
proc create_hier_cell_StatusReg { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_StatusReg() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -type clk aclk
  create_bd_pin -dir I -type rst aresetn
  create_bd_pin -dir I -from 14 -to 0 read_data_cnt
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ps_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins sts_0/S_AXI]

  # Create port connections
  connect_bd_net -net ps_0_FCLK_CLK0 [get_bd_pins aclk] [get_bd_pins sts_0/aclk]
  connect_bd_net -net rst_0_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins sts_0/aresetn]
  connect_bd_net -net rx_0_rd_data_count [get_bd_pins read_data_cnt] [get_bd_pins xlconcat_1/In0]
...
proc create_hier_cell_ADC { parentCell nameHier } {
  ...
  # Create instance: StatusReg
  create_hier_cell_StatusReg [current_bd_instance .] StatusReg
  ...
  connect_bd_intf_net -intf_net ps_0_axi_periph_M01_AXI [get_bd_intf_pins PS/M01_AXI] [get_bd_intf_pins StatusReg/S_AXI]
  ...
  connect_bd_net -net ps_0_FCLK_CLK0 [get_bd_pins ADC/m_axis_aclk] [get_bd_pins DAC/s_axis_aclk] [get_bd_pins PS/FCLK_CLK0] [get_bd_pins RxConfigReg/aclk] [get_bd_pins StatusReg/aclk] [get_bd_pins rx_0/aclk] [get_bd_pins tx_0/aclk]
  connect_bd_net -net rst_0_peripheral_aresetn [get_bd_pins ADC/m_axis_aresetn] [get_bd_pins DAC/s_axis_aresetn] [get_bd_pins PS/rst_periph] [get_bd_pins RxConfigReg/aresetn] [get_bd_pins StatusReg/aresetn] [get_bd_pins rx_0/aresetn] [get_bd_pins tx_0/s_axis_aresetn]
  connect_bd_net -net rx_0_rd_data_count [get_bd_pins StatusReg/read_data_cnt] [get_bd_pins rx_0/rd_data_count]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces PS/ps_0/Data] [get_bd_addr_segs StatusReg/sts_0/s_axi/reg0] SEG_sts_0_reg0
...
preplace port sync -pg 1 -y 680 -defaultsOSRD
preplace port Vaux0 -pg 1 -y 40 -defaultsOSRD
preplace port adc_csn_o -pg 1 -y 740 -defaultsOSRD
preplace port Vaux1 -pg 1 -y -20 -defaultsOSRD
preplace port adc_clk_p_i -pg 1 -y 430 -defaultsOSRD
preplace port dac_rst_o -pg 1 -y 710 -defaultsOSRD
preplace port dac_clk_o -pg 1 -y 770 -defaultsOSRD
preplace port adc_enc_n_o -pg 1 -y 50 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 230 -defaultsOSRD
preplace port dac_sel_o -pg 1 -y 650 -defaultsOSRD
preplace port pulse_on -pg 1 -y 620 -defaultsOSRD
preplace port dac_wrt_o -pg 1 -y 590 -defaultsOSRD
preplace port Vaux8 -pg 1 -y 100 -defaultsOSRD
preplace port adc_clk_n_i -pg 1 -y 460 -defaultsOSRD
preplace port Vaux9 -pg 1 -y 10 -defaultsOSRD
preplace portBus adc_dat_b_i -pg 1 -y 520 -defaultsOSRD
preplace portBus led_o -pg 1 -y 400 -defaultsOSRD
preplace portBus dac_pwm_o -pg 1 -y 20 -defaultsOSRD
preplace portBus adc_dat_a_i -pg 1 -y 490 -defaultsOSRD
preplace portBus dac_dat_o -pg 1 -y 800 -defaultsOSRD
preplace inst PS -pg 1 -lvl 1 -y 60 -defaultsOSRD -resize 335 190
preplace inst DAC -pg 1 -lvl 6 -y 710 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 5 -y 450 -defaultsOSRD
preplace inst cntr_0 -pg 1 -lvl 4 -y 340 -defaultsOSRD
preplace inst tx_0 -pg 1 -lvl 5 -y 720 -defaultsOSRD -resize 243 160
preplace inst xlconcat_0 -pg 1 -lvl 6 -y 400 -defaultsOSRD
preplace inst slice_0 -pg 1 -lvl 5 -y 340 -defaultsOSRD
preplace inst StatusReg -pg 1 -lvl 3 -y -90 -defaultsOSRD -resize 137 120
preplace inst RxConfigReg -pg 1 -lvl 1 -y 740 -defaultsOSRD
preplace inst ADC -pg 1 -lvl 1 -y 510 -defaultsOSRD
preplace inst rx_0 -pg 1 -lvl 2 -y 520 -defaultsOSRD
preplace netloc RxConfigReg_TxForceOn 1 1 4 N 760 N 760 N 760 1270
preplace netloc tx_0_pulse_on 1 5 2 1630 590 1910J
preplace netloc dac_0_dac_dat 1 6 1 1900J
preplace netloc cntr_0_Q 1 4 1 N
preplace netloc rx_0_rd_data_count 1 2 1 550J
preplace netloc fifo_0_M_AXIS 1 1 1 200
preplace netloc adc_dat_a_i_1 1 0 1 -230J
preplace netloc adc_clk_n_i_1 1 0 1 NJ
preplace netloc ps_0_axi_periph_M02_AXI 1 1 1 220
preplace netloc ps_0_axi_periph_M01_AXI 1 1 2 220 -111 N
preplace netloc rst_0_peripheral_aresetn 1 0 6 -200 620 180 280 560 280 NJ 280 1280 810 1620
preplace netloc dac_0_dac_wrt 1 6 1 1930J
preplace netloc dac_0_dac_clk 1 6 1 1910J
preplace netloc adc_0_adc_clk 1 1 5 200 630 N 630 1040J 600 N 600 1610
preplace netloc ps_0_axi_periph_M00_AXI 1 0 2 -220 -60 200
preplace netloc xlconstant_0_dout 1 5 1 1640
preplace netloc xlconcat_0_dout 1 6 1 NJ
preplace netloc ps_0_FCLK_CLK0 1 0 6 -210 610 190 270 540 270 N 270 1290 620 1600
preplace netloc cfg_data1_1 1 1 1 230
preplace netloc RxFTW 1 1 1 220
preplace netloc S_AXI_CFG_1 1 1 4 200 260 N 260 N 260 1300
preplace netloc srst_1 1 1 1 240
preplace netloc ps_0_DDR 1 1 6 250 80 NJ 80 NJ 80 NJ 80 NJ 80 NJ
preplace netloc aresetn_1 1 1 4 250 700 N 700 N 700 N
preplace netloc adc_0_adc_csn 1 1 6 210 640 NJ 640 1050J 610 NJ 610 NJ 610 1920J
preplace netloc adc_dat_b_i_1 1 0 1 NJ
preplace netloc ps_0_FIXED_IO 1 1 6 240 230 NJ 230 NJ 230 NJ 230 NJ 230 NJ
preplace netloc slice_0_Dout 1 5 1 1640
preplace netloc tx_0_M_AXIS 1 5 1 1640
preplace netloc tx_0_start_seq 1 5 2 1620 600 1950J
preplace netloc dac_0_dac_sel 1 6 1 1940J
preplace netloc dac_0_dac_rst 1 6 1 NJ
preplace netloc adc_clk_p_i_1 1 0 1 -230J
levelinfo -pg 1 -250 -10 400 950 1190 1450 1770 1970 -top -170 -bot 1060
"
}
