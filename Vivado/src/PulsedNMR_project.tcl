...
#
# Generated by Vivado on Tue Aug 24 13:29:02 CEST 2021
...
proc create_hier_cell_rx_0 { parentCell nameHier } {
  ...
  set axis_sniffer_1 [ create_bd_cell -type ip -vlnv tijs-roon:user:axis_sniffer:1.0 axis_sniffer_1 ]
  ...
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {2} \
   CONFIG.S_TDATA_NUM_BYTES {4} \
   CONFIG.TDATA_REMAP {2'b00, tdata[31:18]} \
 ] $axis_subset_converter_0
  ...
  connect_bd_intf_net -intf_net axis_sniffer_1_M_AXIS [get_bd_intf_pins axis_sniffer_1/M_AXIS] [get_bd_intf_pins mixer_0/S_AXIS_LO]
  connect_bd_intf_net -intf_net axis_sniffer_1_M_AXIS_SNIF [get_bd_intf_pins axis_sniffer_1/M_AXIS_SNIF] [get_bd_intf_pins axis_subset_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins M_AXIS_DAC1] [get_bd_intf_pins axis_subset_converter_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net dds_0_M_AXIS_DATA [get_bd_intf_pins axis_sniffer_1/S_AXIS] [get_bd_intf_pins dds_0/M_AXIS_DATA]
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_fifo_0/aclk] [get_bd_pins axis_sniffer_0/aclk] [get_bd_pins axis_sniffer_1/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins cic_0/aclk] [get_bd_pins conv_0/aclk] [get_bd_pins dds_0/aclk] [get_bd_pins fifo_generator_0/clk] [get_bd_pins fir_0/aclk] [get_bd_pins mixer_0/aclk] [get_bd_pins pir_rx/aclk] [get_bd_pins reader_rx/aclk] [get_bd_pins sts_rx/aclk]
  ...
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins aresetn] [get_bd_pins axis_sniffer_0/aresetn] [get_bd_pins axis_sniffer_1/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins cic_0/aresetn] [get_bd_pins conv_0/aresetn] [get_bd_pins fir_0/aresetn] [get_bd_pins mixer_0/aresetn] [get_bd_pins reader_rx/aresetn] [get_bd_pins sts_rx/aresetn]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins util_vector_logic_0/Res]
...
proc create_hier_cell_PS { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_constant_0_M_AXIS [get_bd_intf_pins axis_constant_0/M_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net ps_0_axi_periph_M04_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins ps_0_axi_periph/M04_AXI]
...
proc create_hier_cell_ADC { parentCell nameHier } {
  ...
  connect_bd_net -net RxConfigReg_DDSReset [get_bd_pins RxConfigReg/DDSReset] [get_bd_pins util_vector_logic_2/Op1] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net RxConfigReg_TxForceOn [get_bd_pins RxConfigReg/TxForceOn] [get_bd_pins tx_0/pulse_on_in]
  connect_bd_net -net RxConfigReg_rx_fifo_reset [get_bd_pins RxConfigReg/rx_fifo_reset] [get_bd_pins rx_0/reset_fifo]
  ...
  connect_bd_net -net aresetn_1 [get_bd_pins RxConfigReg/TxReset] [get_bd_pins tx_0/TxReset] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net aresetn_dds_1 [get_bd_pins rx_0/aresetn_dds] [get_bd_pins tx_0/aresetn_dds] [get_bd_pins util_vector_logic_2/Res]
  ...
  connect_bd_net -net rst_0_peripheral_aresetn [get_bd_pins ADC/m_axis_aresetn] [get_bd_pins DAC/s_axis_aresetn] [get_bd_pins PS/peripheral_aresetn] [get_bd_pins RxConfigReg/aresetn] [get_bd_pins rx_0/aresetn] [get_bd_pins tx_0/s_axis_aresetn]
  connect_bd_net -net tx_0_blank [get_bd_pins tx_0/blank] [get_bd_pins xlconcat_1/In4]
  connect_bd_net -net tx_0_pulse_out [get_bd_pins tx_0/pulse_out] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net tx_0_sync [get_bd_pins tx_0/sync] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports exp_n_tri_io] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net xlconcat_2_dout [get_bd_ports exp_p_tri_io] [get_bd_ports led_o] [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins xlconcat_1/dout]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces PS/axi_dma_0/Data_S2MM] [get_bd_addr_segs PS/ps_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS/ps_0/Data] [get_bd_addr_segs PS/axi_dma_0/S_AXI_LITE/Reg] -force
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1800 -y 70 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1800 -y 90 -defaultsOSRD
preplace port Vaux0 -pg 1 -lvl 0 -x -50 -y 20 -defaultsOSRD
preplace port Vaux1 -pg 1 -lvl 0 -x -50 -y 40 -defaultsOSRD
preplace port Vaux8 -pg 1 -lvl 0 -x -50 -y 60 -defaultsOSRD
preplace port Vaux9 -pg 1 -lvl 0 -x -50 -y 80 -defaultsOSRD
preplace port Vp_Vn -pg 1 -lvl 0 -x -50 -y 100 -defaultsOSRD
preplace port adc_clk_n_i -pg 1 -lvl 0 -x -50 -y 355 -defaultsOSRD
preplace port adc_clk_p_i -pg 1 -lvl 0 -x -50 -y 380 -defaultsOSRD
preplace port adc_csn_o -pg 1 -lvl 6 -x 1800 -y 110 -defaultsOSRD
preplace port adc_enc_n_o -pg 1 -lvl 6 -x 1800 -y 20 -defaultsOSRD
preplace port adc_enc_p_o -pg 1 -lvl 6 -x 1800 -y 40 -defaultsOSRD
preplace port dac_clk_o -pg 1 -lvl 6 -x 1800 -y 330 -defaultsOSRD
preplace port dac_rst_o -pg 1 -lvl 6 -x 1800 -y 370 -defaultsOSRD
preplace port dac_sel_o -pg 1 -lvl 6 -x 1800 -y 390 -defaultsOSRD
preplace port dac_wrt_o -pg 1 -lvl 6 -x 1800 -y 410 -defaultsOSRD
preplace portBus adc_dat_a_i -pg 1 -lvl 0 -x -50 -y 175 -defaultsOSRD
preplace portBus adc_dat_b_i -pg 1 -lvl 0 -x -50 -y 200 -defaultsOSRD
preplace portBus dac_dat_o -pg 1 -lvl 6 -x 1800 -y 350 -defaultsOSRD
preplace portBus dac_pwm_o -pg 1 -lvl 6 -x 1800 -y 130 -defaultsOSRD
preplace portBus exp_n_tri_io -pg 1 -lvl 6 -x 1800 -y 760 -defaultsOSRD
preplace portBus exp_p_tri_io -pg 1 -lvl 6 -x 1800 -y 700 -defaultsOSRD
preplace portBus led_o -pg 1 -lvl 6 -x 1800 -y 680 -defaultsOSRD
preplace inst ADC -pg 1 -lvl 2 -x 410 -y 200 -defaultsOSRD
preplace inst DAC -pg 1 -lvl 5 -x 1620 -y 370 -defaultsOSRD
preplace inst PS -pg 1 -lvl 3 -x 850 -y 130 -defaultsOSRD -resize 335 190
preplace inst RxConfigReg -pg 1 -lvl 2 -x 410 -y 540 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 2 -x 410 -y 360 -defaultsOSRD
preplace inst rx_0 -pg 1 -lvl 4 -x 1270 -y 260 -defaultsOSRD
preplace inst tx_0 -pg 1 -lvl 4 -x 1270 -y 520 -defaultsOSRD -resize 243 160
preplace inst util_vector_logic_1 -pg 1 -lvl 5 -x 1620 -y 760 -defaultsOSRD
preplace inst util_vector_logic_2 -pg 1 -lvl 3 -x 850 -y 480 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 4 -x 1270 -y 760 -defaultsOSRD
preplace netloc ADC_adc_csn_o 1 2 4 560 -30 NJ -30 NJ -30 1780
preplace netloc RxConfigReg_DDSReset 1 2 2 630 420 1060
preplace netloc RxConfigReg_TxForceOn 1 2 2 NJ 550 1080
preplace netloc RxFTW 1 2 2 610J 250 1090
preplace netloc adc_clk_n_i_1 1 0 2 N 355 120
preplace netloc adc_clk_p_i_1 1 0 2 N 380 N
preplace netloc adc_dat_a_i_1 1 0 2 -30 180 N
preplace netloc adc_dat_b_i_1 1 0 2 N 200 N
preplace netloc aresetn_1 1 2 2 590 580 1090J
preplace netloc aresetn_dds_1 1 3 1 1080 300n
preplace netloc cfg_data1_1 1 2 2 620J 260 N
preplace netloc clk_wiz_0_clk_125 1 1 4 120 100 570 -20 N -20 1470
preplace netloc clk_wiz_0_clk_250_p1 1 2 3 580 -10 N -10 1460
preplace netloc clk_wiz_0_clk_250_p2 1 2 3 590 0 N 0 1430
preplace netloc clk_wiz_0_locked 1 2 3 600J 10 NJ 10 1420J
preplace netloc dac_0_dac_clk 1 5 1 N 330
preplace netloc dac_0_dac_dat 1 5 1 N 350
preplace netloc dac_0_dac_rst 1 5 1 N 370
preplace netloc dac_0_dac_sel 1 5 1 N 390
preplace netloc dac_0_dac_wrt 1 5 1 N 410
preplace netloc ps_0_FCLK_CLK0 1 1 4 130 650 650 560 1050 400 NJ
preplace netloc rst_0_peripheral_aresetn 1 1 4 140 660 660 570 1070 420 NJ
preplace netloc tx_0_blank 1 3 2 1100 610 1460
preplace netloc tx_0_pulse_out 1 3 2 1110 620 1440
preplace netloc tx_0_sync 1 3 2 1120 630 1420
preplace netloc util_vector_logic_1_Res 1 5 1 N 760
preplace netloc xlconcat_2_dout 1 4 2 1450 700 1770
preplace netloc RxConfigReg_rx_fifo_reset 1 2 2 640J 340 N
preplace netloc PS_M01_AXI 1 3 1 1120 122n
preplace netloc fifo_0_M_AXIS 1 2 2 620 240 1080
preplace netloc ps_0_DDR 1 3 3 NJ 74 NJ 74 1770
preplace netloc ps_0_FIXED_IO 1 3 3 NJ 90 NJ 90 N
preplace netloc tx_0_M_AXIS 1 4 1 1440 300n
preplace netloc ps_0_axi_periph_M02_AXI 1 3 1 1110 138n
preplace netloc ps_0_axi_periph_M00_AXI 1 1 3 150 640 N 640 1040
preplace netloc rx_0_M_AXIS_COSINE 1 4 1 1450 260n
preplace netloc S_AXI_CFG_1 1 3 1 1100 154n
levelinfo -pg 1 -50 100 410 850 1270 1620 1800
pagesize -pg 1 -db -bbox -sgen -230 -110 1970 890
",
   "Color Coded_ScaleFactor":"0.834285",
   "Color Coded_TopLeft":"-231,-242",
   "Default View_ScaleFactor":"0.953411",
...
preplace inst DAC -pg 1 -lvl 4 -x 1867 -y 525 -defaultsOSRD
...
preplace inst xlconcat_1 -pg 1 -lvl 3 -x 1331 -y 780 -defaultsOSRD
preplace netloc ADC_adc_csn_o 1 1 4 N 310 1070J 115 NJ 115 N
preplace netloc RxConfigReg_DDSReset 1 1 2 230 640 1070
preplace netloc RxConfigReg_TxForceOn 1 1 2 NJ 650 1110
preplace netloc RxFTW 1 1 2 190J 260 N
...
preplace netloc aresetn_1 1 1 2 N 670 1120J
preplace netloc aresetn_dds_1 1 2 1 1040 320n
preplace netloc cfg_data1_1 1 1 2 210J 350 1090
preplace netloc clk_wiz_0_clk_125 1 0 4 -150 190 160 220 1040 140 1570
preplace netloc clk_wiz_0_clk_250_p1 1 1 3 N 450 1120 440 1520
preplace netloc clk_wiz_0_clk_250_p2 1 1 3 200 430 N 430 1510
preplace netloc clk_wiz_0_locked 1 1 3 180J 410 NJ 410 1540J
preplace netloc dac_0_dac_clk 1 4 1 N 485
preplace netloc dac_0_dac_dat 1 4 1 2020 505n
preplace netloc dac_0_dac_rst 1 4 1 2020 525n
preplace netloc dac_0_dac_sel 1 4 1 2020 545n
preplace netloc dac_0_dac_wrt 1 4 1 2020 565n
preplace netloc ps_0_FCLK_CLK0 1 0 4 -170 180 220 250 1080 420 1530J
preplace netloc rst_0_peripheral_aresetn 1 0 4 -160 200 190 230 1100 130 1550J
preplace netloc tx_0_blank 1 2 2 1130 630 1500
preplace netloc tx_0_pulse_out 1 2 2 1140 640 1490
preplace netloc tx_0_sync 1 2 2 1150 650 1480
preplace netloc util_vector_logic_1_Res 1 4 1 2020 725n
preplace netloc xlconcat_2_dout 1 3 2 1520 670 2020
preplace netloc RxConfigReg_rx_fifo_reset 1 1 2 220J 360 N
preplace netloc PS_M01_AXI 1 2 1 1120 102n
preplace netloc fifo_0_M_AXIS 1 1 2 170 240 1050
preplace netloc ps_0_DDR 1 2 3 NJ 54 NJ 54 2020
preplace netloc ps_0_FIXED_IO 1 2 3 NJ 70 NJ 70 N
preplace netloc tx_0_M_AXIS 1 3 1 1500 455n
preplace netloc ps_0_axi_periph_M02_AXI 1 2 1 1060 118n
preplace netloc ps_0_axi_periph_M00_AXI 1 0 3 -180 -10 N -10 1030
preplace netloc rx_0_M_AXIS_COSINE 1 3 1 1560 280n
preplace netloc S_AXI_CFG_1 1 2 1 1030 134n
levelinfo -pg 1 -220 10 840 1331 1867 2060
pagesize -pg 1 -db -bbox -sgen -400 -150 2230 1570
"
}
