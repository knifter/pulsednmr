...
#
# Generated by Vivado on Thu Aug 26 19:01:23 CEST 2021
...
proc create_hier_cell_mixer_0 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_lfsr_0_M_AXIS [get_bd_intf_pins axis_lfsr_0/M_AXIS] [get_bd_intf_pins axis_subset_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axis_subset_converter_0/M_AXIS] [get_bd_intf_pins mult_0/S_AXIS_CTRL]
  ...
  # Create port connections
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins aclk] [get_bd_pins axis_lfsr_0/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins mult_0/aclk]
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins aresetn] [get_bd_pins axis_lfsr_0/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn]
...
proc create_hier_cell_rx_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {2} \
   CONFIG.S_TDATA_NUM_BYTES {8} \
   CONFIG.TDATA_REMAP {2'b00, tdata[28:15]} \
 ] $axis_subset_converter_1
...
proc create_hier_cell_ADC { parentCell nameHier } {
  ...
  connect_bd_net -net tx_0_sync [get_bd_pins tx_0/sync] [get_bd_pins xlconcat_2/In0]
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1570 -y 100 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1570 -y 120 -defaultsOSRD
...
preplace port adc_clk_n_i -pg 1 -lvl 0 -x -10 -y 315 -defaultsOSRD
preplace port adc_clk_p_i -pg 1 -lvl 0 -x -10 -y 340 -defaultsOSRD
preplace port adc_csn_o -pg 1 -lvl 5 -x 1570 -y 140 -defaultsOSRD
preplace port adc_enc_n_o -pg 1 -lvl 5 -x 1570 -y 20 -defaultsOSRD
preplace port adc_enc_p_o -pg 1 -lvl 5 -x 1570 -y 40 -defaultsOSRD
preplace port dac_clk_o -pg 1 -lvl 5 -x 1570 -y 300 -defaultsOSRD
preplace port dac_rst_o -pg 1 -lvl 5 -x 1570 -y 340 -defaultsOSRD
preplace port dac_sel_o -pg 1 -lvl 5 -x 1570 -y 360 -defaultsOSRD
preplace port dac_wrt_o -pg 1 -lvl 5 -x 1570 -y 380 -defaultsOSRD
preplace portBus adc_dat_a_i -pg 1 -lvl 0 -x -10 -y 135 -defaultsOSRD
preplace portBus adc_dat_b_i -pg 1 -lvl 0 -x -10 -y 160 -defaultsOSRD
preplace portBus dac_dat_o -pg 1 -lvl 5 -x 1570 -y 320 -defaultsOSRD
preplace portBus dac_pwm_o -pg 1 -lvl 5 -x 1570 -y 60 -defaultsOSRD
preplace portBus exp_n_tri_io -pg 1 -lvl 5 -x 1570 -y 760 -defaultsOSRD
preplace portBus exp_p_tri_io -pg 1 -lvl 5 -x 1570 -y 700 -defaultsOSRD
preplace portBus led_o -pg 1 -lvl 5 -x 1570 -y 680 -defaultsOSRD
preplace inst ADC -pg 1 -lvl 1 -x 190 -y 160 -defaultsOSRD
preplace inst DAC -pg 1 -lvl 4 -x 1390 -y 340 -defaultsOSRD
preplace inst PS -pg 1 -lvl 2 -x 580 -y 160 -defaultsOSRD -resize 335 190
preplace inst RxConfigReg -pg 1 -lvl 1 -x 190 -y 500 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 190 -y 320 -defaultsOSRD
preplace inst rx_0 -pg 1 -lvl 3 -x 1020 -y 290 -defaultsOSRD
preplace inst tx_0 -pg 1 -lvl 3 -x 1020 -y 550 -defaultsOSRD -resize 243 160
preplace inst util_vector_logic_1 -pg 1 -lvl 4 -x 1390 -y 760 -defaultsOSRD
preplace inst util_vector_logic_2 -pg 1 -lvl 2 -x 580 -y 640 -defaultsOSRD
preplace inst xlconcat_2 -pg 1 -lvl 3 -x 1020 -y 830 -defaultsOSRD
preplace netloc ADC_adc_csn_o 1 1 4 360 10 NJ 10 NJ 10 1550
preplace netloc RxConfigReg_DDSReset 1 1 2 340 860 N
preplace netloc RxConfigReg_TxForceOn 1 1 2 NJ 510 770
preplace netloc RxConfigReg_rx_fifo_reset 1 1 2 NJ 550 780
preplace netloc RxFTW 1 1 2 360J 270 N
preplace netloc adc_clk_n_i_1 1 0 1 10 315n
preplace netloc adc_clk_p_i_1 1 0 1 N 340
preplace netloc adc_dat_a_i_1 1 0 1 10 135n
preplace netloc adc_dat_b_i_1 1 0 1 N 160
preplace netloc aresetn_1 1 1 2 N 530 830J
preplace netloc aresetn_dds_1 1 2 1 800 350n
preplace netloc cfg_data1_1 1 1 2 380J 290 N
preplace netloc clk_wiz_0_clk_125 1 0 4 40 60 350 280 790 450 1190
preplace netloc clk_wiz_0_clk_250_p1 1 1 3 350 420 N 420 1170
preplace netloc clk_wiz_0_clk_250_p2 1 1 3 340 430 N 430 1220
preplace netloc clk_wiz_0_locked 1 1 3 370J 440 NJ 440 1210J
preplace netloc dac_0_dac_clk 1 4 1 N 300
preplace netloc dac_0_dac_dat 1 4 1 N 320
preplace netloc dac_0_dac_sel 1 4 1 N 360
preplace netloc dac_0_dac_wrt 1 4 1 N 380
preplace netloc rst_0_peripheral_aresetn 1 0 4 20 20 N 20 820 150 1200J
preplace netloc tx_0_blank 1 2 2 840 640 1210
preplace netloc tx_0_pulse_out 1 2 2 850 650 1190
preplace netloc tx_0_sync 1 2 2 860 660 1170
preplace netloc util_vector_logic_1_Res 1 4 1 N 760
preplace netloc xlconcat_2_dout 1 3 2 1200 700 1540
preplace netloc DAC_dac_rst 1 4 1 N 340
preplace netloc ps_0_FIXED_IO 1 2 3 NJ 120 NJ 120 N
preplace netloc fifo_0_M_AXIS 1 1 2 340 40 840
preplace netloc S_AXI_CFG_1 1 2 1 810 184n
preplace netloc PS_M01_AXI 1 2 1 790 152n
preplace netloc ps_0_DDR 1 2 3 NJ 104 NJ 104 1540
preplace netloc rx_0_M_AXIS_COSINE 1 3 1 N 290
preplace netloc tx_0_M_AXIS 1 3 1 1180 270n
preplace netloc ps_0_axi_periph_M00_AXI 1 0 3 30 30 N 30 810
preplace netloc ps_0_axi_periph_M02_AXI 1 2 1 830 168n
levelinfo -pg 1 -10 190 580 1020 1390 1570
pagesize -pg 1 -db -bbox -sgen -190 0 1740 960
",
   "Color Coded_ScaleFactor":"0.911239",
   "Color Coded_TopLeft":"-176,14",
