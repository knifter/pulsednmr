...
#
# Generated by Vivado on Tue Aug 03 18:46:56 CEST 2021
...
proc create_hier_cell_rx_0 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_fifo_0/aclk] [get_bd_pins axis_sniffer_0/aclk] [get_bd_pins axis_sniffer_1/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins cic_0/aclk] [get_bd_pins conv_0/aclk] [get_bd_pins dds_0/aclk] [get_bd_pins fifo_generator_0/clk] [get_bd_pins fir_0/aclk] [get_bd_pins fp_0/aclk] [get_bd_pins mixer_0/aclk] [get_bd_pins pir_rx/aclk] [get_bd_pins reader_rx/aclk] [get_bd_pins sts_rx/aclk]
  ...
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins aresetn] [get_bd_pins axis_sniffer_0/aresetn] [get_bd_pins axis_sniffer_1/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins cic_0/aresetn] [get_bd_pins conv_0/aresetn] [get_bd_pins fir_0/aresetn] [get_bd_pins fp_0/aresetn] [get_bd_pins mixer_0/aresetn] [get_bd_pins reader_rx/aresetn] [get_bd_pins sts_rx/aresetn]
