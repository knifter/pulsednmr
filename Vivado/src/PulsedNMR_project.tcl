...
#
# Generated by Vivado on Mon Aug 02 16:24:03 CEST 2021
...
proc create_hier_cell_rx_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {2} \
   CONFIG.S_TDATA_NUM_BYTES {4} \
   CONFIG.TDATA_REMAP {2'b00, tdata[15:2]} \
 ] $axis_subset_converter_0
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_fifo_0/aclk] [get_bd_pins axis_sniffer_0/aclk] [get_bd_pins axis_sniffer_1/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins cic_0/aclk] [get_bd_pins conv_0/aclk] [get_bd_pins dds_0/aclk] [get_bd_pins fifo_generator_0/clk] [get_bd_pins fir_0/aclk] [get_bd_pins fp_0/aclk] [get_bd_pins mixer_0/aclk] [get_bd_pins pir_rx/aclk] [get_bd_pins reader_rx/aclk] [get_bd_pins sts_rx/aclk]
  ...
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_sniffer_0/aresetn] [get_bd_pins axis_sniffer_1/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins cic_0/aresetn] [get_bd_pins conv_0/aresetn] [get_bd_pins fir_0/aresetn] [get_bd_pins fp_0/aresetn] [get_bd_pins mixer_0/aresetn] [get_bd_pins reader_rx/aresetn] [get_bd_pins sts_rx/aresetn] [get_bd_pins util_vector_logic_0/Op1]
...
proc create_hier_cell_RxConfigReg { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net cfg_0_cfg_data [get_bd_pins cfg_rx/cfg_data] [get_bd_pins rxconfig_slice_0_0/Din] [get_bd_pins rxconfig_slice_16_31/Din] [get_bd_pins rxconfig_slice_1_1/Din] [get_bd_pins rxconfig_slice_32_63/Din] [get_bd_pins rxconfig_slice_7_7/Din]
...
proc create_hier_cell_PS { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins ps_0/S_AXI_GP0]
...
proc create_hier_cell_ADC { parentCell nameHier } {
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces PS/axi_dma_0/Data_S2MM] [get_bd_addr_segs PS/ps_0/S_AXI_GP0/GP0_DDR_LOWOCM] -force
  ...
  exclude_bd_addr_seg -offset 0xE0000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces PS/axi_dma_0/Data_S2MM] [get_bd_addr_segs PS/ps_0/S_AXI_GP0/GP0_IOP]
  exclude_bd_addr_seg -offset 0x40000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces PS/axi_dma_0/Data_S2MM] [get_bd_addr_segs PS/ps_0/S_AXI_GP0/GP0_M_AXI_GP0]
  exclude_bd_addr_seg -offset 0xFC000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces PS/axi_dma_0/Data_S2MM] [get_bd_addr_segs PS/ps_0/S_AXI_GP0/GP0_QSPI_LINEAR]
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 2150 -y 48 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 2150 -y 70 -defaultsOSRD
...
preplace port Vp_Vn -pg 1 -lvl 0 -x -20 -y 100 -defaultsOSRD
preplace port adc_clk_n_i -pg 1 -lvl 0 -x -20 -y 440 -defaultsOSRD
preplace port adc_clk_p_i -pg 1 -lvl 0 -x -20 -y 460 -defaultsOSRD
preplace port adc_csn_o -pg 1 -lvl 5 -x 2150 -y 115 -defaultsOSRD
preplace port adc_enc_n_o -pg 1 -lvl 5 -x 2150 -y 20 -defaultsOSRD
preplace port adc_enc_p_o -pg 1 -lvl 5 -x 2150 -y 90 -defaultsOSRD
preplace port dac_clk_o -pg 1 -lvl 5 -x 2150 -y 485 -defaultsOSRD
preplace port dac_rst_o -pg 1 -lvl 5 -x 2150 -y 530 -defaultsOSRD
preplace port dac_sel_o -pg 1 -lvl 5 -x 2150 -y 550 -defaultsOSRD
preplace port dac_wrt_o -pg 1 -lvl 5 -x 2150 -y 570 -defaultsOSRD
preplace portBus adc_dat_a_i -pg 1 -lvl 0 -x -20 -y 260 -defaultsOSRD
preplace portBus adc_dat_b_i -pg 1 -lvl 0 -x -20 -y 280 -defaultsOSRD
preplace portBus dac_dat_o -pg 1 -lvl 5 -x 2150 -y 510 -defaultsOSRD
preplace portBus dac_pwm_o -pg 1 -lvl 5 -x 2150 -y 140 -defaultsOSRD
preplace portBus exp_n_tri_io -pg 1 -lvl 5 -x 2150 -y 725 -defaultsOSRD
preplace portBus exp_p_tri_io -pg 1 -lvl 5 -x 2150 -y 670 -defaultsOSRD
preplace portBus led_o -pg 1 -lvl 5 -x 2150 -y 645 -defaultsOSRD
preplace inst ADC -pg 1 -lvl 1 -x 200 -y 280 -defaultsOSRD
preplace inst DAC -pg 1 -lvl 4 -x 1957 -y 525 -defaultsOSRD
preplace inst PS -pg 1 -lvl 2 -x 717 -y 110 -defaultsOSRD -resize 335 190
preplace inst RxConfigReg -pg 1 -lvl 1 -x 200 -y 610 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 200 -y 440 -defaultsOSRD
preplace inst rx_0 -pg 1 -lvl 3 -x 1421 -y 280 -defaultsOSRD
preplace inst tx_0 -pg 1 -lvl 3 -x 1421 -y 540 -defaultsOSRD -resize 243 160
preplace inst util_vector_logic_1 -pg 1 -lvl 4 -x 1957 -y 730 -defaultsOSRD
preplace inst util_vector_logic_2 -pg 1 -lvl 2 -x 717 -y 570 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 3 -x 1421 -y 780 -defaultsOSRD
preplace netloc ADC_adc_csn_o 1 1 4 N 290 940J 115 NJ 115 N
preplace netloc RxConfigReg_TxForceOn 1 1 2 NJ 630 1010
preplace netloc RxFTW 1 1 2 370J 280 980
preplace netloc adc_clk_n_i_1 1 0 1 N 440
preplace netloc adc_clk_p_i_1 1 0 1 N 460
preplace netloc adc_dat_a_i_1 1 0 1 N 260
preplace netloc adc_dat_b_i_1 1 0 1 N 280
preplace netloc aresetn_1 1 1 2 N 650 1020J
preplace netloc cfg_data1_1 1 1 2 390J 410 950
preplace netloc clk_wiz_0_clk_125 1 0 4 20 180 350 220 930 150 1670
preplace netloc clk_wiz_0_clk_250_p1 1 1 3 350 420 N 420 1640
preplace netloc clk_wiz_0_clk_250_p2 1 1 3 380 440 N 440 1600
preplace netloc clk_wiz_0_locked 1 1 3 360J 430 NJ 430 1610J
preplace netloc dac_0_dac_clk 1 4 1 N 485
preplace netloc dac_0_dac_dat 1 4 1 2110 505n
preplace netloc dac_0_dac_rst 1 4 1 2110 525n
preplace netloc dac_0_dac_sel 1 4 1 2110 545n
preplace netloc dac_0_dac_wrt 1 4 1 2110 565n
preplace netloc ps_0_FCLK_CLK0 1 0 4 10 170 390 230 910 400 1650J
preplace netloc rst_0_peripheral_aresetn 1 0 4 20 700 N 700 960 410 1620J
preplace netloc xlconcat_2_dout 1 3 2 1620 670 2110
preplace netloc util_vector_logic_1_Res 1 4 1 2110 725n
preplace netloc aresetn_dds_1 1 2 1 1000 350n
preplace netloc RxConfigReg_DDSReset 1 1 2 350 730 N
preplace netloc tx_0_sync 1 2 2 1050 650 1590
preplace netloc tx_0_pulse_out 1 2 2 1040 640 1570
preplace netloc tx_0_blank 1 2 2 1030 630 1580
preplace netloc PS_M01_AXI 1 2 1 1000 102n
preplace netloc fifo_0_M_AXIS 1 1 2 N 270 970
preplace netloc ps_0_axi_periph_M00_AXI 1 0 3 0 -10 N -10 910
preplace netloc ps_0_DDR 1 2 3 NJ 54 NJ 54 2110
preplace netloc ps_0_FIXED_IO 1 2 3 NJ 70 NJ 70 N
preplace netloc ps_0_axi_periph_M02_AXI 1 2 1 920 118n
preplace netloc S_AXI_CFG_1 1 2 1 990 134n
preplace netloc rx_0_M_AXIS_COSINE 1 3 1 1660 280n
preplace netloc tx_0_M_AXIS 1 3 1 1630 455n
levelinfo -pg 1 -20 200 717 1421 1957 2150
pagesize -pg 1 -db -bbox -sgen -200 -100 2320 1570
"
}
