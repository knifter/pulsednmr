...
#
# Generated by Vivado on Mon Oct 25 14:59:23 CEST 2021
...
proc cr_bd_PulsedNMR { parentCell } {
  ...
  tijs-roon:tijs-roon:NMRPulseSequencer:1.2\
...
proc create_hier_cell_tx_0 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk aclk
  create_bd_pin -dir I -type data amp_on
  ...
  set NMRPulseSequencer_0 [ create_bd_cell -type ip -vlnv tijs-roon:tijs-roon:NMRPulseSequencer:1.2 NMRPulseSequencer_0 ]
  ...
  # Create port connections
  connect_bd_net -net NMRPulseSequencer_0_blank_out [get_bd_pins blank] [get_bd_pins NMRPulseSequencer_0/blank_out]
  connect_bd_net -net NMRPulseSequencer_0_pulse_on [get_bd_pins pulse_out] [get_bd_pins NMRPulseSequencer_0/pulse_out] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net NMRPulseSequencer_0_sync_out [get_bd_pins sync] [get_bd_pins NMRPulseSequencer_0/sync_out]
  connect_bd_net -net TxConfigReg_ABdly [get_bd_pins NMRPulseSequencer_0/ABdly_in] [get_bd_pins TxConfigReg/ABdly]
  connect_bd_net -net TxConfigReg_Alen [get_bd_pins NMRPulseSequencer_0/Alen_in] [get_bd_pins TxConfigReg/Alen]
  connect_bd_net -net TxConfigReg_BBcnt [get_bd_pins NMRPulseSequencer_0/BBcnt_in] [get_bd_pins TxConfigReg/BBcnt]
  connect_bd_net -net TxConfigReg_BBdly [get_bd_pins NMRPulseSequencer_0/BBdly_in] [get_bd_pins TxConfigReg/BBdly]
  connect_bd_net -net TxConfigReg_BlankLen [get_bd_pins NMRPulseSequencer_0/BlankLen_in] [get_bd_pins TxConfigReg/BlankLen]
  connect_bd_net -net TxConfigReg_Blen [get_bd_pins NMRPulseSequencer_0/Blen_in] [get_bd_pins TxConfigReg/Blen]
  ...
  connect_bd_net -net TxReset_1 [get_bd_pins TxReset] [get_bd_pins NMRPulseSequencer_0/rst]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins NMRPulseSequencer_0/clk] [get_bd_pins TxConfigReg/aclk] [get_bd_pins axis_zeroer_0/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dsp48_multip_0/CLK] [get_bd_pins pir_tx/aclk]
  connect_bd_net -net amp_on_1 [get_bd_pins amp_on] [get_bd_pins NMRPulseSequencer_0/amp_on]
  ...
  connect_bd_net -net pulse_on_in_1 [get_bd_pins pulse_on_in] [get_bd_pins NMRPulseSequencer_0/force_on]
...
proc create_hier_cell_RxConfigReg { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 TxAmpOn
  ...
  # Create instance: rxconfig_slice_6_6, and set properties
  set rxconfig_slice_6_6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 rxconfig_slice_6_6 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {6} \
   CONFIG.DIN_TO {6} \
   CONFIG.DIN_WIDTH {128} \
  ...
  # Create port connections
  connect_bd_net -net cfg_0_cfg_data [get_bd_pins cfg_rx/cfg_data] [get_bd_pins rxconfig_slice_0_0/Din] [get_bd_pins rxconfig_slice_16_31/Din] [get_bd_pins rxconfig_slice_1_1/Din] [get_bd_pins rxconfig_slice_2_2/Din] [get_bd_pins rxconfig_slice_32_63/Din] [get_bd_pins rxconfig_slice_6_6/Din] [get_bd_pins rxconfig_slice_7_7/Din]
  ...
  connect_bd_net -net rxconfig_slice_6_6_Dout [get_bd_pins TxAmpOn] [get_bd_pins rxconfig_slice_6_6/Dout]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rx_0_M_AXIS_COSINE] [get_bd_intf_pins rx_0/M_AXIS_DAC1] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_net -net RxConfigReg_TxAmpOn [get_bd_pins RxConfigReg/TxAmpOn] [get_bd_pins tx_0/amp_on]
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 2020 -y 100 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 2020 -y 120 -defaultsOSRD
...
preplace port adc_csn_o -pg 1 -lvl 5 -x 2020 -y 140 -defaultsOSRD
preplace port adc_enc_n_o -pg 1 -lvl 5 -x 2020 -y 20 -defaultsOSRD
preplace port adc_enc_p_o -pg 1 -lvl 5 -x 2020 -y 40 -defaultsOSRD
preplace port dac_clk_o -pg 1 -lvl 5 -x 2020 -y 300 -defaultsOSRD
preplace port dac_rst_o -pg 1 -lvl 5 -x 2020 -y 340 -defaultsOSRD
preplace port dac_sel_o -pg 1 -lvl 5 -x 2020 -y 360 -defaultsOSRD
preplace port dac_wrt_o -pg 1 -lvl 5 -x 2020 -y 380 -defaultsOSRD
...
preplace portBus dac_dat_o -pg 1 -lvl 5 -x 2020 -y 320 -defaultsOSRD
preplace portBus dac_pwm_o -pg 1 -lvl 5 -x 2020 -y 60 -defaultsOSRD
preplace portBus exp_n_tri_io -pg 1 -lvl 5 -x 2020 -y 760 -defaultsOSRD
preplace portBus exp_p_tri_io -pg 1 -lvl 5 -x 2020 -y 700 -defaultsOSRD
preplace portBus led_o -pg 1 -lvl 5 -x 2020 -y 680 -defaultsOSRD
preplace inst ADC -pg 1 -lvl 1 -x 190 -y 160 -defaultsOSRD
preplace inst DAC -pg 1 -lvl 4 -x 1805 -y 450 -defaultsOSRD
preplace inst PS -pg 1 -lvl 2 -x 672 -y 160 -defaultsOSRD -resize 335 190
preplace inst RxConfigReg -pg 1 -lvl 1 -x 190 -y 510 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 190 -y 320 -defaultsOSRD
preplace inst rx_0 -pg 1 -lvl 3 -x 1317 -y 284 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 4 -x 1805 -y 190 -defaultsOSRD
preplace inst tx_0 -pg 1 -lvl 3 -x 1317 -y 544 -defaultsOSRD -resize 243 160
preplace inst util_vector_logic_1 -pg 1 -lvl 4 -x 1805 -y 800 -defaultsOSRD
preplace inst util_vector_logic_2 -pg 1 -lvl 2 -x 672 -y 640 -defaultsOSRD
preplace inst xlconcat_2 -pg 1 -lvl 3 -x 1317 -y 824 -defaultsOSRD
preplace netloc ADC_adc_csn_o 1 1 4 360 40 NJ 40 NJ 40 1990
preplace netloc DAC_dac_rst 1 4 1 1980 340n
preplace netloc RxConfigReg_DDSReset 1 1 2 350 854 N
preplace netloc RxConfigReg_TxForceOn 1 1 2 NJ 510 880
preplace netloc RxConfigReg_rx_fifo_reset 1 1 2 NJ 550 870
preplace netloc RxFTW 1 1 2 380J 414 950
...
preplace netloc aresetn_1 1 1 2 N 530 930J
preplace netloc aresetn_dds_1 1 2 2 890 104 1480
preplace netloc cfg_data1_1 1 1 2 370J 394 960
preplace netloc clk_wiz_0_clk_125 1 0 4 -80 70 400 404 970 114 1460
preplace netloc clk_wiz_0_clk_250_p1 1 1 3 390 424 930 124 1520
preplace netloc clk_wiz_0_clk_250_p2 1 1 3 360 444 N 444 1480
preplace netloc clk_wiz_0_locked 1 1 3 410J 434 NJ 434 1500J
preplace netloc dac_0_dac_clk 1 4 1 1960 300n
preplace netloc dac_0_dac_dat 1 4 1 1970 320n
preplace netloc dac_0_dac_sel 1 4 1 1990 360n
preplace netloc dac_0_dac_wrt 1 4 1 2000 380n
preplace netloc rst_0_peripheral_aresetn 1 0 4 -90 630 400 570 900 134 1510J
preplace netloc tx_0_blank 1 2 2 960 660 1520
preplace netloc tx_0_pulse_out 1 2 2 950 640 1480
preplace netloc tx_0_sync 1 2 2 970 650 1540
preplace netloc util_vector_logic_1_Res 1 4 1 1980 760n
preplace netloc xlconcat_2_dout 1 3 2 1490 700 1980
preplace netloc RxConfigReg_TxAmpOn 1 1 2 340J 580 860
preplace netloc rx_0_M_AXIS_COSINE 1 3 1 1490 150n
preplace netloc ps_0_FIXED_IO 1 2 3 870J 50 NJ 50 1960
preplace netloc S_AXI_CFG_1 1 2 1 940 184n
preplace netloc tx_0_M_AXIS 1 3 1 1470 380n
preplace netloc Conn 1 3 1 1500 110n
preplace netloc ps_0_axi_periph_M00_AXI 1 0 3 -70 620 370 560 860
preplace netloc fifo_0_M_AXIS 1 1 3 390 270 920 144 1470
preplace netloc ps_0_axi_periph_M02_AXI 1 2 1 950 168n
preplace netloc PS_M01_AXI 1 2 1 910 152n
preplace netloc Conn3 1 3 1 1530 130n
preplace netloc ps_0_DDR 1 2 3 860J 30 NJ 30 2000
levelinfo -pg 1 -120 190 672 1317 1805 2020
pagesize -pg 1 -db -bbox -sgen -300 -130 2190 1690
",
   "Color Coded_ScaleFactor":"1.0",
   "Color Coded_TopLeft":"-366,-227",
